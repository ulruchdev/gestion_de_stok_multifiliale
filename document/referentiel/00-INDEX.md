...
### Référence : `GS-REF-2026-01` | Version : 0.1 (en constitution) | Ouvert le 17 août 2026
...
| 12 | **Journal des décisions** | `12-journal-decisions.md` | — | ✅ 31 décisions arrêtées, 6 ouvertes |
...
Ces documents ont produit le présent référentiel. Ils sont **gelés au 17 août 2026** et ne sont plus maintenus :

- `document/03-pilotage/GS-AUDIT-2026-01_rapport_incoherences.md` — audit vertical par parcours (blocs A et B rédigés, 29 entrées)
- `document/03-pilotage/INCOHERENCES_DOCUMENTAIRES_StockMaster_CM.docx` — balayage horizontal du corpus (83 contradictions + 16 annexes)

Recoupement : 28 paires communes. Total de points uniques : ≈ 96.
