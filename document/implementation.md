...
| # | Titre | Statut | Commit(s) | Fichiers | Lignes |
|---|---|---|---|---|---|
| **US-001** | Initialisation Spring Boot | ✅ Terminé | `e47186c` | 44 | ~5 389 |
| **US-002** | Flyway & schéma initial | ✅ Terminé | `a7d76eb` | 6 | +412 |
| **US-003** | Gestion erreurs + tests | ✅ Terminé | `c03bff2` | 1 | +203 |
| **US-INT-001** | Test intégration Spring Boot | ✅ Terminé | (non commité) | 1 | +90 |
| **US-INT-002** | Suppression Testcontainers → PostgreSQL direct | ✅ Terminé | (non commité) | 4 | ~20 |
| **US-INT-003** | Activation JaCoCo + fix enum | ✅ Terminé | (non commité) | 2 | ~5 |
| **US-004** | CI/CD pipelines | ✅ Terminé | `e74b481` + fixes | 3 | +223 |
| **US-005** | Docker + docker-compose | ✅ Terminé | `911fb49` | 3 | +213 |
| **US-006** | Inscription entreprise unique | ✅ Terminé | `9fed1df` | 17 | +500 |
| **US-007** | Inscription groupe multi-sites | 🔜 Non commencé | — | — | — |
| **US-008** | Connexion JWT | ✅ Terminé | `9fed1df` | 7 | +457 |
| **US-009 à 013** | Auth (refresh, logout, reset) | 🔜 Non commencé | — | — | — |
...
| Métrique | Valeur |
|---|---|
| US terminées | 7 sur 75 (US-001, 002, 003, 004, 005, 006, 008) |
| US en cours | 0 |
...
| Tests unitaires | 18 |
| Tests d'intégration | 3 (`StockMasterApplicationTest`) |
| Total tests | **21** |
| Branches créées | 6 (toutes mergées) |
| Modules avec code fonctionnel | 2 sur 11 (shared + auth) |
| Modules vides (stubs) | 9 sur 11 |
